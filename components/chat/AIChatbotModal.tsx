  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
        {!isOpen && (
          <div className="hidden sm:flex items-center gap-2 bg-slate-900/90 border border-cyan-500/40 px-3.5 py-2 rounded-2xl shadow-xl backdrop-blur-md text-xs font-semibold text-cyan-300 animate-bounce">
        ...
        <button
          ...
          className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-2xl transition-all duration-300 ${
            isOpen
              ...
              : 'bg-gradient-to-tr from-cyan-500 via-teal-400 to-emerald-400 text-slate-950 shadow-cyan-500/30 hover:scale-110'
          }`}
